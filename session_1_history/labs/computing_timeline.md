# Lab 1 — The Computing & Sports Analytics Timeline
...
Create a timeline of 10 milestones — **5 from computing history, 5 from sports analytics**.  
...
|------|-----------|-----------------|
| 1843 | Ada Lovelace writes the first algorithm | Proved machines could follow logical instructions, not just calculate |
| 1947 | Transistor invented at Bell Labs | Replaced vacuum tubes — made computers small, cheap, reliable |
...
- "NBA 3-point revolution analytics"
- "Expected Goals xG football history"
- "Second Spectrum NBA tracking cameras"
- "StatsBomb football data"
- "Prozone football analysis Premier League"
- "Sports Reference baseball statistics history"
- "Wearable GPS vests football training"
